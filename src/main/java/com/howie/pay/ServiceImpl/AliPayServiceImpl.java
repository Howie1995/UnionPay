...
public class AliPayServiceImpl implements IAliPayService {
	...
	@Override
	public String aliPay(InfoDTO product) {
	...
	@Override
	public String aliRefund(InfoDTO product) {
     ...
     */
	@Override
	public String aliCloseorder(InfoDTO product) {
	...
	@Override
	public String aliPayMobile(InfoDTO product) {
	...
	@Override
	public String aliPayPc(InfoDTO product) {
	...
	@Override
	public String appPay(InfoDTO product) {
